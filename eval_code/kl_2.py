...
generated_folder = './musiccaps_gen_eval'
...
output_file = "kl_divergence_results2.txt"
...
filenames = [f for f in os.listdir(original_folder) if f.endswith('.wav')]
# test 160 files
...
with open(output_file, "w") as f:
    ...
    for batch_filenames in tqdm(audio_batches, desc="Processing Batches"):
        ...
        for filename in batch_filenames:
            ...
            generated_audio = load_audio(os.path.join(generated_folder, filename[1:] + ".wav"), sampling_rate)
...
df.to_csv('kl_divergence_results2.csv', index=False)
