...
files_in_folder2 = os.listdir("./musiccaps_gen_eval")  # list of files in the second folder
...
fad_score = frechet.score(
    "./musiccaps_eval", # path to background set
    "./musiccaps_gen_eval", # path to eval set

    dtype="float32"
)
print("--FAD---")
# write the score to a file
with open("FAD.txt", "w") as f:
